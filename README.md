...
As an engineering major I wanted to understand AI and this is an exellent course. However there are quite a few files missing.

1. You need to create a directory or add in these directories the lr_utils.py which I have added. To reference the lr_utils.py, you need to put the file in a directory (I put in a directory called c:\AI_libraries) and reference the file by issuing the commands in jupyter notebook or your own python IDE:
import sys
sys.path.append("C:\AI_libraries")

2. Also you need to adde the images and datasets which I uploaded.
